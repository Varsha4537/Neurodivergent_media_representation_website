...
export const RedditIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 8c2.648 0 5.028 .826 6.675 2.14a2.5 2.5 0 0 1 2.326 4.36c0 3.59 -4.03 6.5 -9 6.5s-9 -2.91 -9 -6.5a2.5 2.5 0 0 1 2.326 -4.36c1.646 -1.313 4.026 -2.14 6.674 -2.14z" />
    <path d="M12 8l1 -4l6 1" />
    <path d="M12 8l-1 -4l-6 1" />
    <path d="M15 13h.01" />
    <path d="M9 13h.01" />
    <path d="M15.5 17c-.5 -1 -1.5 -2 -3.5 -2s-3 1 -3.5 2" />
  </svg>
);