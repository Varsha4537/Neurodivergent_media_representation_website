...
const GuidelinesPage: React.FC = () => {
    return (
        <PageShell title="Filmmaker Guidelines">
            ...
            {/* Overview Section */}
            <section className="max-w-4xl mx-auto mb-16 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 p-8 rounded-xl border-l-4 border-brand-gold shadow-lg animate-fade-in-up">
            ...
            {/* Chapters Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20 animate-fade-in-up" style={{animationDelay: '100ms'}}>
            ...
            {/* Quiz Section */}
            <section className="bg-black py-16 px-8 rounded-lg border border-gray-700 shadow-xl mb-20 animate-fade-in-up" style={{animationDelay: '300ms'}}>
